...
private:
    ...
    std::list<Package*>::iterator it;           // Used iterator for the destructor--
public:                                           
    ...
    friend std::ostream& operator<<(std::ostream &os, const Customer& customer);   // Overload to output data to console    // Overload concept with the direction of Project 2 by just replaced Store with Customer 
